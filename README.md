...
mybrowser/
├─ assets/
│  ├─ logo.svg, logo.png (optionnel), logo.icns/.ico, loader.gif, ...
├─ config/
│  └─ search_engines.json
├─ services/
│  ├─ model.py        # Worker Gradio
│  └─ search.py       # Scrapers + HTML résultats
├─ ui/
│  └─ window.py       # UI principale (résolution ressources, panneau modèle)
├─ scripts/
│  ├─ build_mac.sh
│  └─ build_win.bat
├─ main.py
